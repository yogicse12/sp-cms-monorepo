...
export const BlogPostStatusSchema = z.enum(['draft', 'published', 'archived', 'scheduled']);
...
export const BlogPostSchema = z.object({
  ...
  excerpt: z.string().min(10, 'Excerpt must be at least 10 characters long').max(500, 'Excerpt must be less than 500 characters'),
  content: z.string(),
